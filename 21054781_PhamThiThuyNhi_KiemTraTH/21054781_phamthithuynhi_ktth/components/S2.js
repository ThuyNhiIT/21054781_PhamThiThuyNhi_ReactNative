...
import { fetchBicycles, setCategory, filterBicycles } from '../redux/bicycleSlice';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.filterButtonsContainer}>
        ...
        <TouchableOpacity
          style={[styles.filterButton, selectedCategory === 'Roadbike' && styles.activeFilter]}
          onPress={() => handleFilterChange('Roadbike')}
        >
          <Text style={styles.filterButtonText}>Roadbike</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.filterButton, selectedCategory === 'Mountain' && styles.activeFilter]}
